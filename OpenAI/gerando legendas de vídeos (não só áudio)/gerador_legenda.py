...
arquivo_video = "ja começou a jornada full stack.mp4"
extensao = arquivo_video.split(".")[-1] # Extraindo a extensão do arquivo de vídeo para garantir que o pydub possa ler corretamente
